...
while(1)
    contador=contador+1;
    valorGirarAvanzar=input('Introduzca un 0 avanzar , 1 girar , 2 modo test robot real, 3 modo test simulador y cualquier numero para salir ')
