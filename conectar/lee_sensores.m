...
% resultado1=samplingAThousandMeasurements(sub_sonar0);
...
function result=samplingAThousandMeasurements(sub_sonar0)
...
value1=calculateDegreeConfidance(num1 ,num1Fict);
value2=calculateDegreeConfidance(num7 ,num7Fict);
value3=calculateDegreeConfidance(num4 ,num4Fict);
value4=calculateDegreeConfidance(num6 ,num6Fict);

wallL=mean([value1,value2]);
wallR=mean([value3,value4]);

resultado=mean([wallL, wallR]);
end
function result=calculateDegreeConfidance(value_me,valorCalculado)
    result=1-(abs(value_me-valorCalculado)/value_me);
end
